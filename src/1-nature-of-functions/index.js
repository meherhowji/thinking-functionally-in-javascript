...
// The way we can return a value of an evaluating using the return keyword and any expression on its right side
( () => { return 1 + 1 } )()      // prints 2 on the console
// the return statement terminates the function immediately
// return statement is differeny and behaves differently than expression, it can only be used in blocks


// 8
// And because we can put any expression to the right of the arrow.
// We can similarly put a function on the right of the arrow as well
() => () => 0
// this is a function when applied, returns a function. And when applied again, returns 0
